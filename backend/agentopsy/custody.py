...
- **Nivel de solo-lectura**: the HONEST label from ``agentopsy.evidence`` —
...
``agentopsy.reports`` ``DocumentStore.create(...)`` API. This module stays pure.
"""
    ...
    *,
    ...
    return {
        ...
        "tool": {
            "name": "Agentopsy",
            "version": __version__,
            "component": "agentopsy.evidence.EvidenceManager",
