"""Superficie HTTP de MITRE ATT&CK. Adaptador fino sobre agentopsy.mitre (RULE 3)."""
...
from agentopsy.mitre.export import coverage_to_hoja, coverage_to_navigator_layer
