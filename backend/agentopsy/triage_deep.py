...
``agentopsy.triage`` (the shallow pass) is pure Python over the bytes of the file
...
from agentopsy.toolkit.wrappers import tsk_fls, tsk_mmls
...
# Same shape as ``agentopsy.triage._decide_family``: a side must clear ``_MIN_HITS``
