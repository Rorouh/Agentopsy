...
- **La allowlist de herramientas** = el catálogo (`agentopsy.toolkit.catalog`) **filtrado
...
from agentopsy.i18n import Mensaje, current_lang
...
from agentopsy.toolkit.catalog import for_profile as tools_for_profile
