...
(CLAUDE.md RULE 3: surfaces stay thin, logic in `agentopsy/toolkit`). Execution venue is
...
from agentopsy.artifact_ref import is_artifact_ref, validate_artifact_ref
from agentopsy.artifacts.store import ArtifactIntegrityError, artifact_store
...
from agentopsy.path_policy import (
    PathKind,
    PathParameter,
    PathPolicyError,
    PathRole,
...
from agentopsy.toolkit.tool import Tool, run_argv
...
_PENDING_OUTPUT_DIR = "__agentopsy_pending_output_dir__"
