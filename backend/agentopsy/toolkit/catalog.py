...
`agentopsy.toolkit.maletin` probes those services and `capabilities` reports the result;
...
from agentopsy.path_policy import BundledPath, PathKind, PathParameter, PathRole
from agentopsy.toolkit.maletin import MALETINES, TOOLKIT_WINDOWS
...
#   ewfmount            Lo usa `agentopsy.triage_deep` por el exec-agent para
