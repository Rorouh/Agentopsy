...
The whole saving of the session-delta transport rests on
...
``agentopsy.executors.session_guard``. The two are kept apart on purpose: a
        ...
        *,
        ...
        if self._stalled_turns >= self.stall_threshold and not self._warned:
            ...
            return (
                ...
                "Comprueba la versión del ejecutor antes de lanzar "
                "análisis largos."
            )
        return None
