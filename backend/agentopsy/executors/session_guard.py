...
cost what a terminal session costs (−72 % measured). It is also the single
most dangerous change in that design: a
...
#: container's HOME *is* the ``agentopsy-cli-auth`` volume, so this resolves
