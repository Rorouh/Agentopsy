...
Patrón deliberadamente igual al de ``agentopsy.reports.writer`` (llamada al
...
from agentopsy.executors.base import ExecutorResult, PromptExecutor
from agentopsy.executors.session_guard import verify_session
...
def extract_graph(
    ...
    *,
    ...
    No escribe en disco: quien persiste es ``agentopsy.graph.store``, y solo si
