...
- ``coverage_to_hoja`` — una HOJA de cálculo real (``agentopsy.export_hoja``: un
  ...
  catálogo Enterprise (``agentopsy.mitre.catalog``); NO se inventan. Si el
...
from agentopsy.i18n import current_lang, t
from agentopsy.export_hoja import build_workbook, iso_utc_ahora, unir
