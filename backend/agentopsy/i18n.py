...
from agentopsy.i18n_catalogo import CATALOGO
...
#
# El contenido vive en `agentopsy.i18n_catalogo`, que es datos puros: este módulo
...
class Mensaje(str):
    ...
    El problema que resuelve: el mensaje de una excepción de `agentopsy/*` tiene
...
_LANG_ACTUAL: ContextVar[Lang] = ContextVar("agentopsy_lang", default=DEFAULT_LANG)
