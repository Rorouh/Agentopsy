"""Entry point — ``python -m forensia.mcp`` arranca el servidor MCP por stdio.

Lifecycle:
- Lee FORENSIA_CLOUD_CONSENT antes que nada: si el operador apunta este
...
- Construye el servidor (forensia.mcp.toolkit.build_server) y lo corre por
...
def main() -> None:
    ...
    try:
        ...
        def _stop(*_args) -> None:
            sys.stderr.write("[forensia.mcp] signal received, shutting down...\n")
            sys.stderr.flush()
